...
// AMD FidelityFX FSR 1 RCAS — GLSL port for Ultima / Minecraft 26.2
...
void main() {
    ...
    vec3 color = ultima_fsr_rcas(InSampler, ip, Con0.x);
    float alpha = ultima_fsr_load(InSampler, ivec2(ip)).a;
